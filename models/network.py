...
class Resnet_34_Source(torch.nn.Module):
    def __init__(self, pretrain):
        super(Resnet_34_Source, self).__init__()
...
class Resnet_18_Cloner(torch.nn.Module):
    def __init__(self, pretrain):
        super(Resnet_18_Cloner, self).__init__()
...
def get_networks(config, load_checkpoint=False):
    ...
    #vgg = Resnet_34_Source(pretrain).cuda()
    #model = Resnet_18_Cloner(pretrain).cuda()
    #print('Resnet cloner\n')
    #print(model)
    #print('Resnet source\n')
    #print(vgg)
